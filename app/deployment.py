...
<style>
body {
background-image: url("Background.jpg");  /* Use the path to your local image */
...
st.header("US Housing Data Pricing Predictions")
...
if button:
    ...
    st.write("Your Price is being predicted, Please Wait ... ")
    time.sleep(3)
    ...
    y_pred = model.predict(df_pred)  #if normalization done, values will be different!!!

    text = f'The House Price will be around ${y_pred[0].round(2)}'
